...
data_dir = "data"
encrypted_user_marketing_info = pd.read_csv(f"{data_dir}/Demo_EncryptedUserMarketingInfo.csv", encoding='utf-8')
...
print("Time taken to decrypt marketing: ", time.time() - start_time)